...
from foodgram.const import (INGREDIENT_MEASUREMENT_UNIT_MAX_LENGTH,
                            INGREDIENT_MIN_AMOUNT_IN_RECIPE,
                            INGREDIENT_NAME_MAX_LENGTH, RECIPE_IMAGE_UPLOAD_TO,
                            RECIPE_MIN_COOKING_TIME, RECIPE_NAME_MAX_LENGTH)
